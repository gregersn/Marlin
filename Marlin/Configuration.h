...
#define STRING_CONFIG_H_AUTHOR "(greger, default config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Klønni"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 21, 10, 0 }
...
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS 230 // X_BED_SIZE
